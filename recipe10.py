...
from recipe10_oauth_login import oauth_login
...
if TIMELINE_NAME == 'public':
    MAX_PAGES = 1
if TIMELINE_NAME == 'friends' and MAX_PAGES > 16:
    MAX_PAGES = 16
...
while page_num <= MAX_PAGES:
  KW['page'] = page_num
	api_call = getattr(t , TIMELINE_NAME + '_timeline')
